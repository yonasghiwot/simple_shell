#include "main.h"
/**
 * _getenv - afunction that gets the value of the global enviroment variable
 * @name: name of the global enveroment varaible variable
 * Return: string
 */
...
/**
 * linkpath - function that creates a linked list for path directories
